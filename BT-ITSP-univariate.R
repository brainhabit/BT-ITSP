#==========
# Script for univariate twin modelling for the study: Individual variability in sensory processing: etiological structure and developmental links to autism.
# 
...
setwd('C:/Users/giobu365/Documents/BT-ITSP')
list.files()
...
data <- read.csv(file='C:/Users/your_username/Documents/BT-ITSP/data/twin_data_ITSP_all_wQCHAT.csv',header=T,sep=',')
names(data);dim(data)

### select variables for analysis:

var <- 'resVestibular' # name of variable
